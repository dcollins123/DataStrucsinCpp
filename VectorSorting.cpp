...
int main(int argc, char* argv[]) {
    ...
    case 2:
        ...
        break;
    default:
        csvPath = "eBid_Monthly_Sales.csv";     //use "eBid_Monthly_Sales_Dec_2016" for a shorter list
    }
    ...
    while (choice != 9) {
        ...
        case 3:                     //selection sort with timing results
            ticks = clock();
            selectionSort(bids);
            ticks = clock() - ticks;
        ...
        case 4:                     //quicksort with timing results
            ticks = clock();
